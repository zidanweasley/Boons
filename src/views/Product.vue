...
import HeaderBoons from "@/components/HeaderBoons.vue";
import ReleatedProductBoons from "@/components/ReleatedProductBoons.vue";


import FooterBoons from "@/components/FooterBoons.vue";
